...
public class Fragment_3Neutral extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        TextView tv1 = (TextView) rootview.findViewById(R.id.title_neutral);
        TextView tv2 = (TextView) rootview.findViewById(R.id.description_neutral);
        TextView tv3 = (TextView) rootview.findViewById(R.id.TV_advice);
        TextView tv4 = (TextView) rootview.findViewById(R.id.neutral_advice);
